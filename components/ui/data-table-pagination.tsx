    ...
    <div className="flex flex-col items-center justify-between gap-4 px-2 sm:flex-row">
      ...
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            className="hidden h-8 w-8 p-0 lg:flex bg-white text-gray-700 border-gray-200 hover:bg-gray-50"
          ...
          <Button
            variant="outline"
            className="h-8 w-8 p-0 bg-white text-gray-700 border-gray-200 hover:bg-gray-50"
