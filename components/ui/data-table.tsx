            ...
            {isLoading
              ? (
                  Array.from({ length: pagination.pageSize }).map((_, rowIndex) => (
                    ...
                    <TableRow key={`skeleton-row-${rowIndex}`} className="bg-white">
              ...
              : isError
                ? (
                    <TableRow className="bg-red-50">
                      <TableCell colSpan={columns.length} className="h-24 text-center text-red-600 font-medium">
                  ...
                  ? (
                      table.getRowModel().rows.map(row => (
                        <TableRow
                          ...
                          className="bg-white hover:bg-gray-50 data-[state=selected]:bg-blue-50"
                        >
