...
const ongDonations: Donation[] = [
  ...
  { id: 25, items: [{ food: "Açúcar", quantity: 7, unit: "kg" }, { food: "Sal", quantity: 3, unit: "kg" }], donor: "Carlos Souza", status: "Entregue", date: "07/10/2025" },
  { id: 28, items: [{ food: "Arroz", quantity: 30, unit: "kg" }], donor: "João Silva", status: "Pendente", date: "04/10/2025" },
  { id: 31, items: [{ food: "Feijão", quantity: 12, unit: "kg" }], donor: "Pedro Costa", status: "Entregue", date: "01/10/2025" },
  { id: 34, items: [{ food: "Leite", quantity: 8, unit: "L" }], donor: "Ana Oliveira", status: "Em processamento", date: "28/09/2025" },
];
...
export default function ONGDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-50">
      {/* Sidebar */}
      <Sidebar activePage="dashboard-ong" />
