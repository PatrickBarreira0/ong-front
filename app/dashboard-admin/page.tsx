...
const allDonations: Donation[] = [
  ...
  { id: 11, items: [{ food: "Arroz", quantity: 30, unit: "kg" }, { food: "Feijão", quantity: 20, unit: "kg" }, { food: "Macarrão", quantity: 10, unit: "unidades" }], user: "João Silva", ong: "Anjos da Noite", status: "Entregue", date: "21/10/2025" },
  { id: 12, items: [{ food: "Leite", quantity: 12, unit: "L" }], user: "Maria Santos", ong: "Esperança Viva", status: "Pendente", date: "20/10/2025" },
  { id: 13, items: [{ food: "Açúcar", quantity: 4, unit: "kg" }], user: "Pedro Costa", ong: "Comunidade Solidária", status: "Entregue", date: "19/10/2025" },
  { id: 14, items: [{ food: "Óleo", quantity: 2, unit: "L" }, { food: "Pão", quantity: 25, unit: "unidades" }], user: "Ana Oliveira", ong: "Anjos da Noite", status: "Em processamento", date: "18/10/2025" },
  { id: 15, items: [{ food: "Sal", quantity: 5, unit: "kg" }], user: "Carlos Souza", ong: "Esperança Viva", status: "Entregue", date: "17/10/2025" },
  { id: 16, items: [{ food: "Arroz", quantity: 15, unit: "kg" }], user: "João Silva", ong: "Comunidade Solidária", status: "Pendente", date: "16/10/2025" },
  { id: 17, items: [{ food: "Feijão", quantity: 25, unit: "kg" }, { food: "Macarrão", quantity: 15, unit: "unidades" }], user: "Maria Santos", ong: "Anjos da Noite", status: "Entregue", date: "15/10/2025" },
  { id: 18, items: [{ food: "Leite", quantity: 6, unit: "L" }], user: "Pedro Costa", ong: "Esperança Viva", status: "Em processamento", date: "14/10/2025" },
  { id: 19, items: [{ food: "Pão", quantity: 30, unit: "unidades" }, { food: "Óleo", quantity: 4, unit: "L" }, { food: "Açúcar", quantity: 6, unit: "kg" }], user: "Ana Oliveira", ong: "Comunidade Solidária", status: "Entregue", date: "13/10/2025" },
  { id: 20, items: [{ food: "Sal", quantity: 4, unit: "kg" }], user: "Carlos Souza", ong: "Anjos da Noite", status: "Pendente", date: "12/10/2025" },
  { id: 21, items: [{ food: "Arroz", quantity: 35, unit: "kg" }, { food: "Feijão", quantity: 18, unit: "kg" }], user: "João Silva", ong: "Esperança Viva", status: "Entregue", date: "11/10/2025" },
  { id: 22, items: [{ food: "Macarrão", quantity: 20, unit: "unidades" }], user: "Maria Santos", ong: "Comunidade Solidária", status: "Em processamento", date: "10/10/2025" },
  { id: 23, items: [{ food: "Leite", quantity: 9, unit: "L" }, { food: "Pão", quantity: 22, unit: "unidades" }], user: "Pedro Costa", ong: "Anjos da Noite", status: "Entregue", date: "09/10/2025" },
  { id: 24, items: [{ food: "Óleo", quantity: 6, unit: "L" }], user: "Ana Oliveira", ong: "Esperança Viva", status: "Pendente", date: "08/10/2025" },
  { id: 25, items: [{ food: "Açúcar", quantity: 7, unit: "kg" }, { food: "Sal", quantity: 3, unit: "kg" }], user: "Carlos Souza", ong: "Comunidade Solidária", status: "Entregue", date: "07/10/2025" },
];
